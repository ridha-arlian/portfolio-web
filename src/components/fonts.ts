...
export const textStyles = defineTextStyles({
  ...
  titleProjects: {
    ...
    value: {
      fontFamily: 'var(--font-plus-jakarta-sans)',
      fontWeight: '800',
      fontSize: { base: '14px', sm: '16px', md: '14px', lg: '22px', xl: '22px' },
      lineHeight: '24px',
      letterSpacing: '0px',
      textDecoration: 'none',
      textTransform: 'none',
  ...
  footerButton: {
    ...
    value: {
      fontFamily: 'var(--font-plus-jakarta-sans)',
      fontWeight: '800',
      fontSize: { base: '12px', sm: '16px', md: '14px', lg: '20px', xl: '20px' },
      lineHeight: '24px',
      letterSpacing: '0px',
      textDecoration: 'none',
      textTransform: 'none',
  ...
  footerText: {
    ...
    value: {
      fontFamily: 'var(--font-plus-jakarta-sans)',
      fontWeight: '800',
      fontSize: { base: '10px', sm: '16px', md: '14px', lg: '14px', xl: '14px' },
      lineHeight: '24px',
      letterSpacing: '0px',
      textDecoration: 'none',
      textTransform: 'none',
